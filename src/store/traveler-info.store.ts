...
// -----------------------------
interface useTravelerInfoStore {
...
function lruTouch(state: useTravelerInfoStore, userId: string) {
...
// Zustand store
// -----------------------------
export const useTravelerInfoStore = create<useTravelerInfoStore>()(
...
export const selectSegment =
    <K extends SegmentKey>(userId: string, segment: K) =>
        (state: useTravelerInfoStore) =>
            state.users.get(userId)?.segments[segment] as
            | SegmentState<SegmentDataMap[K]>
            | undefined;

export const selectStatus =
    (userId: string, segment: SegmentKey) => (state: useTravelerInfoStore) =>
...
export const selectActiveUserId = (state: useTravelerInfoStore) =>
    state.activeUserId;
