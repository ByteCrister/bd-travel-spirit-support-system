        ...
        <AnimatePresence>
            {open && (
                ...
                >
                    ...
                    {/* Modal Container */}
                    <motion.div
                        className="relative z-10 flex h-full max-h-[95vh] w-full max-w-7xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl"
                    ...
                    >
                        {/* Gradient Header */}
                        <div className="relative border-b border-gray-200 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 px-6 py-5">
