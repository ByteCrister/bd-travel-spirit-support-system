...
export default function AdsPage(): JSX.Element {
    ...
    return (
        <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="min-h-screen p-4 lg:p-6 xl:p-8 bg-gradient-to-br from-slate-50 via-white to-slate-50/50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950/50"
        >
