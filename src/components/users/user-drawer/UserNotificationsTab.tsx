...
import { NOTIFICATION_PRIORITY } from "@/constants/notification.const";
...
export function UserNotificationsTab({ userId }: UserNotificationsTabProps) {
    ...
    const notificationsSegment = useUserStore(userId ? selectSegment(userId, "notifications") : () => undefined);
