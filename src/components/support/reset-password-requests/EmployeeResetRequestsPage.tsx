...
export default function EmployeeResetRequestsPage() {
  ...
  return (
    <motion.div
      className="min-h-screen p-4 lg:p-6 xl:p-8 bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950"
      initial="hidden"
      animate="visible"
