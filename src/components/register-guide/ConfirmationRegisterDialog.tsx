...
export function ConfirmationRegisterDialog({
    ...
    return (
        <AlertDialog open={open} onOpenChange={handleOpenChange}>
            <AlertDialogContent className="max-w-lg border border-border shadow-2xl p-0 overflow-hidden bg-gradient-to-br from-card to-muted/50">
                ...
                <div className="p-6 sm:p-8 max-h-[80vh] overflow-y-auto">
                    <AlertDialogHeader>
                        <div className="flex items-start space-x-4 mb-4">
                            <div className="relative">
                                <div className="w-14 h-14 bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-950/40 dark:to-amber-900/40 rounded-2xl flex items-center justify-center shadow-lg shadow-amber-500/20 ring-2 ring-amber-200/50 dark:ring-amber-800/50">
                            ...
                            <div className="flex-1">
                                <AlertDialogTitle className="text-2xl font-bold text-foreground mb-1">
                        ...
                        {email && verificationStep !== 'verified' && (
                            <div className="mb-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-200 dark:border-blue-800 rounded-2xl p-5">
                        ...
                        {verificationStep === 'verified' && (
                            <div className="mb-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border border-green-200 dark:border-green-800 rounded-2xl p-5">
                                <div className="flex items-center mb-3">
                                    <CheckCircle2 className="w-5 h-5 mr-2 text-green-600" />
                                    <h3 className="font-semibold text-foreground">Email Verified Successfully!</h3>
                                </div>
                        ...
                        <div className="text-base text-left space-y-4">
                            <div className="bg-gradient-to-br from-blue-50 to-indigo-50/50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-200/60 dark:border-blue-800/60 rounded-2xl p-5 shadow-sm">
                                <div className="font-semibold text-foreground text-base mb-2 flex items-center">
                            ...
                            <div className="bg-gradient-to-br from-amber-50 via-orange-50/30 to-amber-50 dark:from-amber-950/30 dark:via-orange-950/20 dark:to-amber-950/30 border border-amber-300/60 dark:border-amber-700/60 rounded-2xl p-5 shadow-md">
                                <div className="flex items-center mb-3">
                                ...
                                <ul className="space-y-2.5">
                                    {[
                                        ...
                                        <li key={index} className="flex items-start text-sm text-amber-900 dark:text-amber-200 group">
                                            <div className="mt-0.5 mr-3 flex-shrink-0">
                                                <div className="w-5 h-5 rounded-full bg-background border-2 border-amber-400 dark:border-amber-600 flex items-center justify-center shadow-sm group-hover:border-amber-500 transition-colors">
                    ...
                    <AlertDialogFooter className="flex-col sm:flex-row gap-3 mt-6">
                        <AlertDialogCancel
                            ...
                            className="w-full sm:w-auto order-2 sm:order-1 h-11 rounded-xl border-2 border-border hover:border-border hover:bg-muted font-semibold transition-all shadow-sm"
                        >
                            {cancelText}
                        </AlertDialogCancel>
                        <AlertDialogAction
