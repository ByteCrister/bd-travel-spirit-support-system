                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex items-start sm:items-center gap-4 sm:gap-6">
                        ...
                        <Link href="/" className="shrink-0 group">
                            <Button
                                variant="ghost"
                                size="sm"
                                className="flex items-center gap-2 rounded-xl border border-border bg-background text-foreground hover:bg-muted hover:border-emerald-400/60"
                            >
                        ...
                        <div className="space-y-1">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="min-w-0">
                                    <p className={`${inter.className} text-xs uppercase tracking-[0.2em] text-emerald-600 dark:text-emerald-300/80`}>
                                        Guide Application
                                    </p>
                                    <h1
                    ...
                    <div className="flex justify-end">
                        <Button
                            ...
                            className="flex items-center gap-2 rounded-xl border-emerald-500/60 bg-background text-emerald-700 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/30"
                        >
