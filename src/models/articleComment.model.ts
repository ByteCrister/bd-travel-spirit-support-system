...
const TravelCommentSchema = new Schema<ITravelComment>(
    {
        ...
        articleId: { type: Schema.Types.ObjectId, ref: 'TravelArticle', required: true, index: true },

        // Optional parent comment for nested/threaded replies
        parentId: { type: Schema.Types.ObjectId, ref: 'TravelComment', default: null },
...
TravelCommentSchema.methods.reject = async function (): Promise<ITravelComment> {
...
export const TravelCommentModel =
    models.TravelComment || model<ITravelComment>('TravelComment', TravelCommentSchema);
