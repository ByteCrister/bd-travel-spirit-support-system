...
function generateItineraryEntryDTO(day: number) {
  return {
    ...
    title: faker.lorem.words(3),
    description: faker.lorem.paragraph(),
    mealsProvided: randomSubset(
      Object.values(MEALS_PROVIDED) as MealsProvided[],
      2,
    ),
...
export async function GET(
  ...
  const tour: TourDetailDTO = {
    ...
    accommodationType: randomSubset(
    ...
    transportModes: randomSubset(
      Object.values(TRANSPORT_MODE) as TransportMode[],
      2,
    ),
    pickupOptions: [
      {
    ...
    ageSuitability: randomEnum(
      Object.values(AGE_SUITABILITY) as AgeSuitability[],
    ),
    accessibility: {
    ...
    // =============== MODERATION ===============
    moderationStatus: randomEnum(
      Object.values(MODERATION_STATUS) as ModerationStatus[],
    ),
    ...
    completedAt: faker.datatype.boolean(0.1)
      ...
      : undefined,
    reApprovalRequestedAt: faker.datatype.boolean(0.1)
      ? faker.date.recent().toISOString()
      : undefined,
    ...
    createdAt,
    updatedAt,
    deletedAt: faker.datatype.boolean(0.1)
      ? faker.date.recent().toISOString()
      : undefined,

    suspension: faker.datatype.boolean(0.1)
      ? generateTourSuspension()
      : undefined,
