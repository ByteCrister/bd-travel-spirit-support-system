...
async function unsuspendTraveler(
    req: NextRequest,
    { params }: Params
    ...
    await withTransaction(async (session) => {
        ...
        traveler.suspension = undefined;
        traveler.accountStatus = ACCOUNT_STATUS.ACTIVE;
...
export const POST = withErrorHandler(unsuspendTraveler);