...
<head>
  ...
  <title>Verify your email – BD Travel Spirit Support System</title>
  <style type="text/css">
    body, table, td, p, a {
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="email-card" style="max-width:600px; width:100%; background-color:#ffffff; border-radius:20px; box-shadow:0 10px 30px rgba(15,23,42,0.08); border:1px solid #eef1f4; border-collapse:separate;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td style="padding-left:14px; vertical-align:middle;">
                    ...
                    <span class="badge" style="display:inline-block; font-size:12px; font-weight:700; color:#006666; background:#e6f5f5; text-transform:uppercase; letter-spacing:0.6px; padding:4px 10px; border-radius:999px; margin-top:6px;">Employee Verification</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="content-pad" style="padding:28px 32px 8px 32px;">
              <h1 style="color:#0f172a; font-size:22px; font-weight:700; margin:0 0 12px 0; letter-spacing:-0.3px;">Verify your email address</h1>
              <p style="color:#475569; font-size:15px; line-height:1.6; margin:0 0 8px 0;">Hello,</p>
              <p style="color:#475569; font-size:15px; line-height:1.6; margin:0 0 4px 0;">
                You're being onboarded as an employee of <strong style="color:#0f172a;">BD Travel Spirit Support</strong>.
                Please verify <strong style="color:#0f172a;">${escapeHtml(email)}</strong> by entering the token below on the verification page.
              </p>
              ...
              <div class="token-box" style="background:linear-gradient(180deg, #0f172a 0%, #1e293b 100%); padding:22px 24px; font-family:'Courier New', monospace; font-size:26px; font-weight:700; letter-spacing:4px; color:#5eead4; border-radius:12px; word-break:break-all; margin:24px 0; text-align:center;">
                <div class="token-label" style="font-size:11px; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:1px; margin-bottom:8px; text-align:center;">Verification Token</div>
              ...
              <div class="info-card" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:10px; padding:16px 18px; margin:20px 0;">
                <p style="color:#334155; font-size:14px; line-height:1.6; margin:0;">
                  <strong style="color:#0f172a;">Instructions:</strong> Copy token above, paste into verification form.
                  Expires in <strong style="color:#0f172a;">1 hour</strong>. Didn't request this? Ignore this email.
                </p>
              </div>
            </td>
          </tr>
